...
Lisp Playground は現在、GitHub Pages 上で配信する静的 SPA であり、学習継続に必要な軽量データは localStorage に保存している。
...
その前提に立つ限り、Lisp Playground の T-401 の出発点は Firebase より Supabase の方が整合的である。